package bus.monkeybusiness.com.sambus.utility.preferences;

/**
 * Created by neeraj on 6/8/15.
 */
public class PrefsKeys {
    ...
    public static final String X_COOKIES = "xsrfCookiesInfo_bus";

    public static final String A_COOKIES = "aphCookiesInfo_bus";

    public static final String LOGIN_RESPONSE_DATA = "loginResponseData_bus";

    public static final String CHECK_LOGIN_DATA = "checkLoginData_bus";

    public static final String LECTURE_RESPONSE_DATA = "lectureResponseData_bus";

    public static final String STUDENT_LIST_RESPONSE_DATA = "studentListResponseData_bus";

    public static final String STUDENT_DETAILS_RESPONSE_DATA = "studentDetailsResponseData_bus";

    public static final String ATTD_STATUS = "attendanceStatus_bus";
    ...
    public static final String REFER_SCREEN_DATA = "referScreenData";
    ...
    public static final String OTHER_REFERRER_CODE = "otherReferrerCode";
    ...
    public static final String IS_API_HIGHER_20 = "isApiHigherThan20";
